...
public class UserTemplateSaveController extends BaseController {
   ...
   private User currentUser = new User();
    ...
    static ObservableList<Template> templateList = FXCollections.observableArrayList(); // Danh sách template đầy đủ
    ...
    private void loadTemplatesIntoTableView() {
        List<Template> templates = templateService.getAllTemplatesForUserId(currentUser.getId());//currentUser.getId()
    ...
    void viewBtnEnter(ActionEvent event) throws IOException {
    	...
    	switchUserTemplateViewSaveToView(event);
    }
    ...
    @FXML
    void addUserTemplateEnter(ActionEvent event) throws IOException {
        switchToUserAddTemplate(event);
    }
}
